...
<head>
    ...
    <title>Admin Dashboard - JobLinks Rwanda</title>
    <style>
        body {
...
<body>
    ...
    <aside>
        <ul>
            ...
            <li><a href="?data=employee">Employees</a></li>
            <li><a href="?data=employer">Employers</a></li>
    ...
    <main>
        ...
        <p>Manage all operations of your site</p>
        <p>No data found</p>
